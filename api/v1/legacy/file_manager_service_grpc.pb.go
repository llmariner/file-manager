...
func (c *filesInternalServiceClient) GetFilePath(ctx context.Context, in *v1.GetFilePathRequest, opts ...grpc.CallOption) (*v1.GetFilePathResponse, error) {
	out := new(v1.GetFilePathResponse)
...
func (UnimplementedFilesInternalServiceServer) GetFilePath(context.Context, *v1.GetFilePathRequest) (*v1.GetFilePathResponse, error) {
	return nil, status.Errorf(codes.Unimplemented, "method GetFilePath not implemented")
}
...
func _FilesInternalService_GetFilePath_Handler(srv interface{}, ctx context.Context, dec func(interface{}) error, interceptor grpc.UnaryServerInterceptor) (interface{}, error) {
	...
	handler := func(ctx context.Context, req interface{}) (interface{}, error) {
		return srv.(FilesInternalServiceServer).GetFilePath(ctx, req.(*v1.GetFilePathRequest))
	}
	return interceptor(ctx, in, info, handler)
}
