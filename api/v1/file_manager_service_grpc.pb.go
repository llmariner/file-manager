...
const (
	FilesService_ListFiles_FullMethodName  = "/llmoperator.files.server.v1.FilesService/ListFiles"
	FilesService_GetFile_FullMethodName    = "/llmoperator.files.server.v1.FilesService/GetFile"
	FilesService_DeleteFile_FullMethodName = "/llmoperator.files.server.v1.FilesService/DeleteFile"
)
...
func (c *filesServiceClient) ListFiles(ctx context.Context, in *ListFilesRequest, opts ...grpc.CallOption) (*ListFilesResponse, error) {
	...
	err := c.cc.Invoke(ctx, FilesService_ListFiles_FullMethodName, in, out, opts...)
	if err != nil {
		return nil, err
	}
	return out, nil
...
func (c *filesServiceClient) GetFile(ctx context.Context, in *GetFileRequest, opts ...grpc.CallOption) (*File, error) {
	out := new(File)
	err := c.cc.Invoke(ctx, FilesService_GetFile_FullMethodName, in, out, opts...)
	if err != nil {
		return nil, err
	}
	return out, nil
...
func (c *filesServiceClient) DeleteFile(ctx context.Context, in *DeleteFileRequest, opts ...grpc.CallOption) (*DeleteFileResponse, error) {
	...
	err := c.cc.Invoke(ctx, FilesService_DeleteFile_FullMethodName, in, out, opts...)
	if err != nil {
		return nil, err
	}
	return out, nil
...
const (
	FilesWorkerService_GetFilePath_FullMethodName = "/llmoperator.files.server.v1.FilesWorkerService/GetFilePath"
)
...
func (c *filesWorkerServiceClient) GetFilePath(ctx context.Context, in *GetFilePathRequest, opts ...grpc.CallOption) (*GetFilePathResponse, error) {
	...
	err := c.cc.Invoke(ctx, FilesWorkerService_GetFilePath_FullMethodName, in, out, opts...)
	if err != nil {
		return nil, err
	}
	return out, nil
...
func _FilesWorkerService_GetFilePath_Handler(srv interface{}, ctx context.Context, dec func(interface{}) error, interceptor grpc.UnaryServerInterceptor) (interface{}, error) {
	...
	info := &grpc.UnaryServerInfo{
		Server:     srv,
		FullMethod: FilesWorkerService_GetFilePath_FullMethodName,
	}
	handler := func(ctx context.Context, req interface{}) (interface{}, error) {
...
const (
	FilesInternalService_GetFilePath_FullMethodName = "/llmoperator.files.server.v1.FilesInternalService/GetFilePath"
)
...
func (c *filesInternalServiceClient) GetFilePath(ctx context.Context, in *GetFilePathRequest, opts ...grpc.CallOption) (*GetFilePathResponse, error) {
	out := new(GetFilePathResponse)
	err := c.cc.Invoke(ctx, FilesInternalService_GetFilePath_FullMethodName, in, out, opts...)
	if err != nil {
		return nil, err
	}
	return out, nil
...
func _FilesInternalService_GetFilePath_Handler(srv interface{}, ctx context.Context, dec func(interface{}) error, interceptor grpc.UnaryServerInterceptor) (interface{}, error) {
	...
	info := &grpc.UnaryServerInfo{
		Server:     srv,
		FullMethod: FilesInternalService_GetFilePath_FullMethodName,
	}
	handler := func(ctx context.Context, req interface{}) (interface{}, error) {
