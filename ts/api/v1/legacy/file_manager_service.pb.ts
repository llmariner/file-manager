...
export class FilesInternalService {
  static GetFilePath(req: LlmarinerFilesServerV1File_manager_service.GetFilePathRequest, initReq?: fm.InitReq): Promise<LlmarinerFilesServerV1File_manager_service.GetFilePathResponse> {
    return fm.fetchReq<LlmarinerFilesServerV1File_manager_service.GetFilePathRequest, LlmarinerFilesServerV1File_manager_service.GetFilePathResponse>(`/llmoperator.files.server.v1.FilesInternalService/GetFilePath`, {...initReq, method: "POST", body: JSON.stringify(req)})
  }
}